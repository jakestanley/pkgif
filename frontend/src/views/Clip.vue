        ...
        <table>
            ...
            <tbody>
                <tr v-for="(caption,i) in captions">
                    <td>{{i}}</td>
                    <td><input type="text" @change="inputCaptionStart($event, i)" v-model="caption.start"></td>
...
import { ref } from 'vue'
    ...
    export default {
        ...
        mounted() {
            ...
            axios
                .get("http://localhost:7131/clip/"+this.id)
                .then(response => {
        ...
        methods: {
            ...
            preview() {
                ...
                axios
                    .get("http://localhost:7131/clip/"+this.id+"/preview")
                    .then(response => {
