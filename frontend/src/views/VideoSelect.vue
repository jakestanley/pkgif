<template>
    ...
    <input v-model="location" id="location_computer" type="radio" name="location" value="computer"><label for="location_computer"> From my computer</label><br>
    <input v-model="location" id="location_internet" type="radio" name="location" value="internet"><label for="location_internet"> From the Internet</label>
    ...
    <div v-show="location=='internet'">
        ...
        <label for="url">URL </label><input type="text" v-on:change="getVideoInfo()" placeholder="https://www.youtube.com/watch?v=dQw4w9WgXcQ" id="url" v-model="videoUrl"/>
    </div>
...
export default {
    ...
    methods: {
        getVideoInfo() {
            ...
            axios.post("http://localhost:7131/video", {
